...
void Shader::setVec3(const char* uniformName, glm::vec3 value) const const
{
...
{
	glUniformMatrix3fv(glGetUniformLocation(this->shader, uniformName), 1, GL_FALSE, glm::value_ptr(value));
}
