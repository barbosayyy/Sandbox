...
namespace Sb {
    ...
    Mesh Model::AssimpProcessMesh(aiMesh* mesh, const aiScene* scene, String path){
        ...
        material._diffuseMap = AssimpLoadMaterialTextures(mat, aiTextureType_DIFFUSE, path).at(0);
        ...
        material._specularMap = AssimpLoadMaterialTextures(mat, aiTextureType_SPECULAR, path).at(0);
